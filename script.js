const contentData = {
  ...
  styro: "부착상표 등 스티로폼과 다른 재질은 제거한 후 배출 \ -스티로폼 완충재, 농·수·축산물 포장용 발포스티렌상자 \ -비해당 품목: 타 재질과 코팅 또는 접착된 발포스티렌, 건축용 내·외장재 스티로폼, 음식물이 묻어 있거나 이물질을 제거하기 어려운 경우등은 종량제봉투, 특수규격마대 또는 대형폐기물 처리 등 지자체 조례에 따라 배출은 종량제봉투, 특수규격마대에 넣어 배출하거나 대형폐기물로 처리하는 등 지방자치단체 조례에 따라 배출 ",
